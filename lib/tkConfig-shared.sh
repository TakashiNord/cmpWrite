...
# build directory.
TK_BUILD_LIB_SPEC='-L/home/andreask/dbn/lba/GlobalBuildArena/builds/win32-ix86/tk/win/win32-ix86 -ltk86'

# String to pass to linker to pick up the Tk library from its
# installed directory.
TK_LIB_SPEC='-LC:/Tcl86/lib -ltk86'
...
# compiled.
TK_SRC_DIR='/home/andreask/dbn/lba/GlobalBuildArena/builds/win32-ix86/tk'
...
# build directory.
TK_BUILD_STUB_LIB_SPEC='-L/home/andreask/dbn/lba/GlobalBuildArena/builds/win32-ix86/tk/win/win32-ix86 -ltkstub86'

# String to pass to linker to pick up the Tk stub library from its
# installed directory.
TK_STUB_LIB_SPEC='-LC:/Tcl86/lib -ltkstub86'

# Path to the Tk stub library in the build directory.
TK_BUILD_STUB_LIB_PATH='/home/andreask/dbn/lba/GlobalBuildArena/builds/win32-ix86/tk/win/win32-ix86/tkstub86.lib'

# Path to the Tk stub library in the install directory.
TK_STUB_LIB_PATH='C:/Tcl86/lib/tkstub86.lib'
